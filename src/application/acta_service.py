...
from src.domain.models import DatosActa, Persona
...
class ActaService:
    ...
    def generate_respaldo(self, data: DatosActa) -> Tuple[bool, str]:
    ...
    def generate_formateo_suite(self, data_entrega: DatosActa, data_respaldo: DatosActa, data_devolucion: DatosActa) -> Tuple[bool, str]:
        ...
        try:
            ...
            self.excel_repo.save_acta_record(data_entrega)
